...
const VideoUploader = () => {
  ...
  const steps: Array<{
    ...
    { id: 1, label: "Upload", status: uploading ? "loading" : "current" },
    { id: 2, label: "Transcribe", status: "pending" },
    ...
    <div className="w-screen min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="text-center font-bold text-[5rem] p-10 flex items-center justify-center gap-3">
          <span className={`${flag ? "text-blue-500" : "text-white"}`}>
            BOGUS
          </span>
          <span className={`${flag ? "text-white" : "text-blue-500"}`}>
            CLIP
          </span>
        </div>
        <button
        ...
        {uploading && (
          <div className="h-3 w-1/3 bg-gray-50 my-10 rounded-full overflow-hidden">
            <div
