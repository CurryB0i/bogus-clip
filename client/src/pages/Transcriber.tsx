...
const Transcriber = () => {
  ...
  const steps: Array<{
    ...
    { id: 1, label: "Upload", status: "completed" },
    {
      id: 2,
      label: "Transcribe",
      status: transcribing ? "loading" : "current",
    },
      ...
      <div className="w-full flex-1 flex flex-col gap-5 items-center justify-center p-10">
        ...
        <div className="text-center">
          ...
          <button
            ...
            className={`p-5 text-2xl font-bold rounded-xl text-center 
              mx-auto transition-all flex items-center justify-center gap-5
              ${
                !transcribing
